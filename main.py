...
if __name__ == '__main__':
    ...
    for file, features_header in files_features:
        ...
        randomforest.rf_mycorrhizae(f"filtered_{file.split('.')[0]}_mycorrhizae.csv", num_estimators=1000, rand_state=10, size_of_test=0.3, mycorrhizae_weight=0.8, non_mycorrhizae_weight=1)
